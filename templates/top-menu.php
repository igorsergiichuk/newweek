...
<nav class="navbar navbar-inverse" role="navigation">
    <div class="container-fluid">
        ...
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="http://localhost/news/index.php">NEWWEEK</a>
        </div>
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav">
                <li class="active"><a href="http://localhost/news/admin.php">Admin panel</a></li>
            </ul>
                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <?php if(isLoggedIn()): ?>
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li><a href="http://localhost/news/logout.php">Logout</a></li>
                            </ul>
                        </li>
                    <?php else: ?>
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li><a href="http://localhost/news/login.php">Login</a></li>
                                <li role="separator" class="divider"></li>
                                <li><a href="http://localhost/news/register.php">Register</a></li>
                            </ul>
                        </li>
                    <?php endif ?>
                </ul>
...
<form action="http://localhost/news/search.php" role="search" id="searchform" method="POST">
